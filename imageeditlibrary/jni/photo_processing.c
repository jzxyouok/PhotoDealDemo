...
void Java_com_xinlan_imageeditlibrary_editimage_fliter_PhotoProcessing_nativeApplyBlur(JNIEnv* env, jobject thiz) {
	applyBlur(&bitmap);
}

void Java_com_xinlan_imageeditlibrary_editimage_fliter_PhotoProcessing_nativeApplyMasic(JNIEnv* env, jobject thiz) {
	applyMasic(&bitmap);
}
